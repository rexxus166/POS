...
import { Head, router, Link } from '@inertiajs/react'; // Gunakan router untuk post manual
                ...
                <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-white shadow-sm z-10">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <Link
                            ...
                            className="p-2 bg-gray-100 hover:bg-indigo-50 text-gray-500 hover:text-indigo-600 rounded-lg transition-colors"
