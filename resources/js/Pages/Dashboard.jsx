            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-indigo-600 overflow-hidden shadow-sm sm:rounded-lg p-6 text-white flex flex-col justify-center items-center hover:bg-indigo-700 transition cursor-pointer">
